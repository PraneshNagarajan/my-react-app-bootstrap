            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  using bootstrap css-framework. It will cover sevral topics
                  from scratch. It is for Begineers and Experienced. It will
                  help you create websites within few minutes.
                </p>
